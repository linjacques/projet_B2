...
$idu=$_SESSION["idu"];
$req = "select * from users INNER JOIN publication on users.idu = publication.idu where idu ='$idu'";
      ...
      while ($historique = mysqli_fetch_assoc($resultat)) {
        echo"
          <div class='historique'>
            ...
            <p> <a href= 'detailPublication.php?idp=".$publication["idp"]." & idu=".$_SESSION["idu"]." & email= ".$_SESSION['email']."  '> <img src=' ".$publication["image"]." ' width='100' > </a>  </p> 
