...
if (isset($terme))
{
 ...
 $req = "SELECT idu, nom, prenom,photo, LEFT(nom, 1) AS first_letter_nom, LEFT(prenom, 1) AS first_letter_prenom 
         FROM users WHERE nom LIKE '$terme%' OR prenom LIKE '$terme%'";
 $res =mysqli_query($id,$req);
